...
import it.unimi.dllcm.migate.repository.search.LanguageSearchRepository;
...
public class LanguageResource {
    ...
    public ResponseEntity<Language> partialUpdateLanguage(
        ...
        Optional<Language> result = languageRepository
            ...
            .map(savedLanguage -> {
                languageSearchRepository.save(savedLanguage);
    ...
    public List<Language> searchLanguages(@RequestParam String query) {
        ...
        return StreamSupport.stream(languageSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
